...
use Xiashaung\LumenGenerator\Model\EloquentModel;
...
class EloquentModelBuilder
{
     ...
     * @return void
     */
    public function resetManager($connection)
    {
        $this->manager = $this->databaseManager->connection($connection)->getDoctrineSchemaManager();
    }
