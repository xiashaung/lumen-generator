...
namespace Xiashaung\LumenGenerator\Command;

use Illuminate\Console\Command;
use Xiashaung\LumenGenerator\Config;
use Xiashaung\LumenGenerator\Generator;
use Symfony\Component\Console\Input\InputArgument;
use Symfony\Component\Console\Input\InputOption;

/**
 * Class GenerateLumenModelCommand
 * @package Xiashaung\LumenGenerator\Command
 */
...
/**
    ...
    public function handle()
    {
        ...
        $this->generator->setConnection($connection);
        return $this->fire();
    }
