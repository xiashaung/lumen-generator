...
use Xiashaung\LumenGenerator\Model\ClassModel;
use Xiashaung\LumenGenerator\Model\ClassNameModel;
...
use Xiashaung\LumenGenerator\Helper\ClassHelper;
use Xiashaung\LumenGenerator\Helper\TitleHelper;
...
class EloquentModel extends ClassModel
{
    ...
    public function __construct($className, $baseClassName, $tableName = null)
    {
        ...
        $cn->addImplements(ClassHelper::getShortClassName(Xiashaung\MicroServiceCrud\Models\CrudModelInterface::class));
        $this->setName($cn);
        $this->addUses(new UseClassModel(ltrim($baseClassName, '\\')));
        $this->addUses(new UseClassModel('Xiashaung\MicroServiceCrud\Models\CrudModelInterface'));
